По всем вопросам и предложениям пишите мне - t.me/aqa_pro_mentor
...
1. Нажми на Code -> Download ZIP
   <img width="923" height="483" alt="Screenshot 2025-12-17 at 13 59 54" src="https://github.com/user-attachments/assets/94a6aa2f-e941-4c0c-9adb-bb9c736ee296" />
### Установка
1. Откройте `chrome://extensions`.
2. Включите «Режим разработчика».
3. Нажмите «Загрузить распакованное» и выберите папку проекта `hh-autoreply-extension-chrome` (где лежит `manifest.json`).
